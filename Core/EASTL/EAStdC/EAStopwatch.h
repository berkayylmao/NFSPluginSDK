  ...
  namespace StdC {
    ...
    class EASTDC_API Stopwatch {
     public:
      ...
      enum Units {
        kUnitsCycles =
            0,  /// Stopwatch clock ticks. May or may not match CPU clock ticks 1:1, depending on
        ...
        kUnitsCPUCycles =
            1,  /// CPU clock ticks (or similar equivalent for the platform). Not recommended for
     ...
     private:
      ...
      float
          mfStopwatchCyclesToUnitsCoefficient;  /// Coefficient is defined seconds per cycle
