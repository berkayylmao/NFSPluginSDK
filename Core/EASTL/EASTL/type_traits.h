...
#define EASTL_TYPE_TRAIT_is_const_CONFORMANCE 1  // is_const is conforming.
  ...
  };  // Note here that T is const, not the reference to T. So is_const is false. See
      // section 8.3.2p1 of the C++ standard.
...
#define EASTL_TYPE_TRAIT_is_volatile_CONFORMANCE 1  // is_volatile is conforming.
  ...
  };  // Note here that T is volatile, not the reference to T. So is_const is false. See
      // section 8.3.2p1 of the C++ standard.
...
#if defined(_MSC_VER) && \
    (_MSC_VER <= 1600)  // VS2010 and earlier mistakenly report: "cannot add a reference to a
...
#include <Core/EASTL/EASTL/internal/type_fundamental.h>
#include <Core/EASTL/EASTL/internal/type_transformations.h>
#include <Core/EASTL/EASTL/internal/type_properties.h>
#include <Core/EASTL/EASTL/internal/type_compound.h>
#include <Core/EASTL/EASTL/internal/type_pod.h>
