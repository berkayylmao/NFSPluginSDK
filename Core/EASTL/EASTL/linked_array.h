...
#include <Core/EASTL/EASTL/linked_ptr.h>          // Defines linked_ptr_base
...
namespace eastl {
  ...
  class linked_array {
   protected:
    ...
    void link(const linked_array&
                  linkedArray) {  // This code can only be called when we are in a reset state.
