  ...
  class list_map
   ...
   public:
    typedef rbtree<Key, eastl::list_map_data<eastl::pair<const Key, T> >, Compare, Allocator,
                   eastl::use_value_first<eastl::list_map_data<eastl::pair<const Key, T> > >, true,
                   true>
                                                 base_type;
    ...
    typedef typename base_type::node_type
        node_type;  // Despite the internal and external values being different, we're keeping the
                    // node type the same as the base in order to allow for pool allocation.  See
                    // EASTL/map.h for more information.
...
// functionality:
  ...
  template <typename Key, typename T, typename Compare, typename Allocator>
  inline list_map<Key, T, Compare, Allocator>::list_map(const Compare&        compare,
