...
namespace eastl {
  ...
  class ring_buffer {
   ...
   public
       :  // We declare public so that global comparison operators can be implemented without adding
   ...
   public:
    ...
    ring_buffer(std::initializer_list<value_type> ilist,
                const allocator_type&             allocator =
                    allocator_type());  // This function sets the capacity to be equal to the size
  ...
  operator-(const ring_buffer_iterator<T, PointerA, ReferenceA, Container>& a,
    ...
    typedef typename ring_buffer_iterator<T, PointerA, ReferenceA, Container>::difference_type
        difference_type;
  ...
  */
  ...
  template <typename T, typename Container, typename Allocator>
  void ring_buffer<T, Container, Allocator>::insert(const_iterator position, size_type n,
  ...
  template <typename T, typename Container, typename Allocator>
  template <typename InputIterator>
  void ring_buffer<T, Container, Allocator>::insert(const_iterator position, InputIterator first,
                                                    InputIterator last) {
