...
#include <Core/EASTL/EASTL/ratio.h>
...
#elif defined(EA_PLATFORM_POSIX)  // Posix means Linux, Unix, and Macintosh OSX, among others
  ...
  namespace chrono {
    ...
    namespace Internal {
      template <typename FromDuration, typename ToDuration,
                typename CommonPeriod = typename ratio_divide<typename FromDuration::period,
                                                              typename ToDuration::period>::type,
                typename CommonRep    = typename eastl::decay<typename eastl::common_type<
                    typename ToDuration::rep, typename FromDuration::rep, intmax_t>::type>::type,
      ...
      struct DurationCastImpl<FromDuration, ToDuration, CommonPeriod, CommonRep, false, true> {
        inline static ToDuration DoCast(const FromDuration& d) {
          return ToDuration(static_cast<typename ToDuration::rep>(
              static_cast<CommonRep>(d.count()) * static_cast<CommonRep>(CommonPeriod::num)));
        }
      };
      ...
      struct DurationCastImpl<FromDuration, ToDuration, CommonPeriod, CommonRep, true, false> {
        inline static ToDuration DoCast(const FromDuration& d) {
          return ToDuration(static_cast<typename ToDuration::rep>(
              static_cast<CommonRep>(d.count()) / static_cast<CommonRep>(CommonPeriod::den)));
        }
      };
    ...
    class duration {
     ...
     public:
      ...
      EA_CONSTEXPR duration() : mRep() {}

      duration(const duration& other) : mRep(Rep(other.mRep)) {}

      duration& operator=(const duration& other) { mRep = other.mRep; }
#else
    ...
    typename eastl::common_type<duration<Rep1, Period1>, duration<Rep2, Period2>>::type
        EASTL_FORCE_INLINE
        operator+(const duration<Rep1, Period1>& lhs, const duration<Rep2, Period2>& rhs) {
      typedef typename eastl::common_type<duration<Rep1, Period1>, duration<Rep2, Period2>>::type
          common_duration_t;
    ...
    inline EA_CONSTEXPR
        time_point<Clock, typename eastl::common_type<Duration1, duration<Rep2, Period2>>::type>
        operator+(const time_point<Clock, Duration1>& lhs, const duration<Rep2, Period2>& rhs) {
      typedef time_point<Clock,
                         typename eastl::common_type<Duration1, duration<Rep2, Period2>>::type>
          common_timepoint_t;
    ...
    inline EA_CONSTEXPR
        time_point<Clock, typename eastl::common_type<Duration2, duration<Rep1, Period1>>::type>
        operator+(const duration<Rep1, Period1>& lhs, const time_point<Clock, Duration2>& rhs) {
      typedef time_point<Clock,
                         typename eastl::common_type<Duration2, duration<Rep1, Period1>>::type>
          common_timepoint_t;
    ...
    inline EA_CONSTEXPR typename eastl::common_type<Duration1, Duration2>::type operator-(
        const time_point<Clock, Duration1>& lhs, const time_point<Clock, Duration2>& rhs) {
...
#define EASTL_NS_PER_TICK 100
      ...
      uint64_t GetTicks() {
        ...
        if (result == EINVAL) result = clock_gettime(CLOCK_REALTIME, &ts);
...
#error "chrono not implemented for platform"
    ...
    class system_clock {
     public:
      ...
      static time_point now() EA_NOEXCEPT { return time_point(duration(Internal::GetTicks())); }
    };
