...
#define EASTL_TYPE_TRAIT_is_signed_CONFORMANCE 1  // is_signed is conforming.
  ...
  struct is_signed_helper<char> : public true_type {};
    ...
    ((__WCHAR_MAX__ == 2147483647) || \
     (__WCHAR_MAX__ == 32767))  // GCC defines __WCHAR_MAX__ for most platforms.
  template <>
  ...
  struct is_unsigned_helper<char> : public true_type {};
    ...
    (defined(__WCHAR_MAX__) &&          \
     ((__WCHAR_MAX__ == 4294967295U) || \
      (__WCHAR_MAX__ == 65535)))  // GCC defines __WCHAR_MAX__ for most platforms.
  template <>
...
#define EASTL_TYPE_TRAIT_is_base_of_CONFORMANCE 1  // is_base_of is conforming.
  ...
  struct is_base_of
      : public eastl::integral_constant<bool, __is_base_of(Base, Derived) ||
...
#define EASTL_TYPE_TRAIT_common_type_CONFORMANCE 1  // common_type is conforming.
  ...
  struct common_type<T, U> {
    static T&&                   t();
    static U&&                   u();
    typedef decltype(true ? t()
                          : u()) type;  // The type of a tertiary expression is set by the compiler
