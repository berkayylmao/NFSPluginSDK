...
#include <Core/EASTL/EABase/eabase.h>
...
#define EASTL_TYPE_TRAIT_is_pod_CONFORMANCE \
  ...
  template <typename T>  // We check for has_trivial_constructor only because the VC++ is_pod does.
                         ...
                         struct is_pod
      : public eastl::integral_constant<bool, (__has_trivial_constructor(T) && __is_pod(T)) ||
...
#define EASTL_TYPE_TRAIT_is_pod_CONFORMANCE 1  // is_pod is conforming.
  ...
  template <typename T>
  struct is_pod : public eastl::integral_constant<bool, __is_pod(T) || eastl::is_void<T>::value ||
                                                            eastl::is_scalar<T>::value> {};
#else
#define EASTL_TYPE_TRAIT_is_pod_CONFORMANCE \
...
#define EASTL_TYPE_TRAIT_is_standard_layout_CONFORMANCE \
  ...
  template <typename T>  // There's not much we can do here without some compiler extension.
  struct is_standard_layout
      : public eastl::integral_constant<bool, is_void<T>::value || is_scalar<T>::value> {};
#endif
...
#define EASTL_TYPE_TRAIT_has_trivial_constructor_CONFORMANCE \
  ...
  struct has_trivial_constructor
      : public eastl::integral_constant<bool,
                                        __has_trivial_constructor(T) || eastl::is_pod<T>::value> {};
#elif EASTL_COMPILER_INTRINSIC_TYPE_TRAITS_AVAILABLE && \
...
#define EASTL_TYPE_TRAIT_has_trivial_destructor_CONFORMANCE \
  ...
  struct has_trivial_destructor
      : public eastl::integral_constant<bool,
                                        __has_trivial_destructor(T) || eastl::is_pod<T>::value> {};
#elif EASTL_COMPILER_INTRINSIC_TYPE_TRAITS_AVAILABLE && \
    (defined(_MSC_VER) || defined(EA_COMPILER_GNUC) || defined(EA_COMPILER_CLANG))
#define EASTL_TYPE_TRAIT_has_trivial_destructor_CONFORMANCE \
  1  // has_trivial_destructor is conforming.
...
#define EASTL_TYPE_TRAIT_is_abstract_CONFORMANCE 0
  ...
  class is_abstract_helper {
    ...
    static eastl::no_type test(
        T1 (*)[1]);  // The following: 'typedef SomeAbstractClass (*SomeFunctionType)[1];' is
                     // invalid (can't have an array of abstract types) and thus doesn't choose this
                     // path.
...
#define EASTL_TYPE_TRAIT_is_constructible_CONFORMANCE 0
  ...
  struct is_constructible {
    static const bool value =
        eastl::is_constructible_helper<typename eastl::remove_all_extents<T>::type>::value &&
        ...
        eastl::is_same<Arg1, eastl::unused>::value;  // so disallow them. This will result in cases
                                                     // being potentially false negatives.
...
#define EASTL_TYPE_TRAIT_is_constructible_CONFORMANCE 1
  ...
  typename first_type_select<eastl::true_type,
  ...
  struct is_constructible_helper_2<true, T, Arg0>
      : public eastl::identity<decltype(
            can_construct_scalar_helper<T>::can(eastl::declval<Arg0>()))>::type {};
  ...
  struct is_constructible_helper_1
      : public is_constructible_helper_2<
            eastl::is_scalar<T>::value || eastl::is_reference<T>::value, T, Args...> {};
  ...
  struct is_constructible
      : public is_constructible_helper_1<
            (eastl::is_abstract<typename eastl::remove_all_extents<T>::type>::value ||
             eastl::is_array_of_unknown_bounds<T>::value ||
...
// necessary for full conformance) use it.
  ...
  template <typename T>
  struct is_trivially_constructible<T, T>
      : public eastl::integral_constant<bool, eastl::is_constructible<T>::value &&
...
#define EASTL_TYPE_TRAIT_is_trivially_constructible_CONFORMANCE 1
  ...
  struct is_trivially_constructible
      : public eastl::integral_constant<
            bool,
            eastl::is_constructible<T, Args...>::value&& __is_trivially_constructible(T, Args...)> {
  };
...
#define EASTL_TYPE_TRAIT_is_trivial_CONFORMANCE                        \
  ...
  struct is_trivial_helper
      : public eastl::integral_constant<bool,
                                        eastl::is_trivially_copyable<T>::value &&
...
#define EASTL_TYPE_TRAIT_is_nothrow_constructible_CONFORMANCE \
  ...
  struct is_nothrow_constructible_helper<true, T, Args...>
      : public eastl::integral_constant<
            bool, is_nothrow_constructible_helper_noexcept_wrapper<T, Args...>::value> {};
  ...
  struct is_nothrow_constructible
      : public eastl::is_nothrow_constructible_helper<eastl::is_constructible<T, Args...>::value, T,
                                                      Args...> {};
...
#define EASTL_DECLARE_IS_TRIVIALLY_MOVE_CONSTRUCTIBLE(T, isTrivallyMoveConstructible) \
  ...
  ///////////////////////////////////////////////////////////////////////
    ...
    defined(                                                                       \
        _MSC_VER)  // VS2012 mis-compiles the conforming code below and so must be placed here.
#define EASTL_TYPE_TRAIT_is_assignable_CONFORMANCE 0
  ...
  struct is_assignable_helper {
    ...
    static const bool isArithmetic =
        (eastl::is_arithmetic<T1>::value && eastl::is_arithmetic<U1>::value);
    static const bool isSameScalar = (eastl::is_same<T1, U1>::value &&
                                      eastl::is_scalar<T1>::value && eastl::is_scalar<U1>::value);
...
#define EASTL_TYPE_TRAIT_is_trivially_assignable_CONFORMANCE \
  ...
  struct is_trivially_assignable
      : eastl::integral_constant<
            bool, is_trivially_assignable_helper<eastl::is_assignable<T, U>::value, T, U>::value> {
  };
...
#define EASTL_TYPE_TRAIT_is_trivially_assignable_CONFORMANCE \
  ...
  struct is_trivially_assignable
      : eastl::integral_constant<
            bool, eastl::is_assignable<T, U>::value &&
...
#define EASTL_TYPE_TRAIT_is_nothrow_assignable_CONFORMANCE 1
  ...
  struct is_nothrow_assignable : eastl::integral_constant<bool, __is_nothrow_assignable(T, U)> {};
    ...
    defined(__EDG_VERSION__)  // EDG mis-compiles the conforming code below and so must be placed
                              // here.
...
#define EASTL_TYPE_TRAIT_is_trivially_copy_assignable_CONFORMANCE \
  ...
  struct is_trivially_copy_assignable
      : public integral_constant<bool,
                                 eastl::is_scalar<T>::value || eastl::is_pod<T>::value ||
...
#define EASTL_TYPE_TRAIT_is_destructible_CONFORMANCE 1
    ...
    defined(EA_COMPILER_NO_FUNCTION_TEMPLATE_DEFAULT_ARGS) || defined(_MSC_VER) || \
    defined(__EDG_VERSION__)  // VS2012 and EDG mis-compile the conforming code below and so must be
                              // placed here.
#define EASTL_TYPE_TRAIT_is_destructible_CONFORMANCE 0
  ...
  struct is_destructible
      : public eastl::integral_constant<
            bool, !eastl::is_array_of_unknown_bounds<T>::value && !eastl::is_void<T>::value &&
...
#define EASTL_TYPE_TRAIT_is_destructible_CONFORMANCE 1
  ...
  template <typename T, typename U = decltype(eastl::declval<eastl::destructible_test_helper<T> >()
  ...
  struct is_destructible_helper
      : public eastl::identity<decltype(eastl::destructible_test_function<T>(0))>::type {
...
#define EASTL_TYPE_TRAIT_is_trivially_destructible_CONFORMANCE \
  ...
  struct is_trivially_destructible  // Can't use just __has_trivial_destructor(T) because some
      ...
      : public integral_constant<
            bool, eastl::is_destructible<T>::value &&
...
#define EASTL_TYPE_TRAIT_is_trivially_destructible_CONFORMANCE 0
  ...
  template <typename T>
  struct is_trivially_destructible : public eastl::is_trivially_destructible_helper<
...
#define EASTL_TYPE_TRAIT_is_nothrow_destructible_CONFORMANCE \
  ...
  struct is_nothrow_destructible_helper<T, true>  // If the expression T::~T is a noexcept
      ...
      : public eastl::integral_constant<bool,
                                        is_nothrow_destructible_helper_noexcept_wrapper<T>::value> {
  };
