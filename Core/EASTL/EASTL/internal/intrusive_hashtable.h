...
#include <Core/EASTL/EASTL/internal/hashtable.h>
...
namespace eastl {
  ...
  /// intrusive_hashtable
  ///
  template <typename Key, typename Value, typename Hash, typename Equal, size_t bucketCount,
            bool bConstIterators, bool bUniqueKeys>
  class intrusive_hashtable {
   public:
    typedef intrusive_hashtable<Key, Value, Hash, Equal, bucketCount, bConstIterators, bUniqueKeys>
                      this_type;
    typedef Key       key_type;
    typedef Value     value_type;
    ...
    typedef
        typename type_select<bUniqueKeys, pair<iterator, bool>, iterator>::type insert_return_type;
  ...
  template <typename U, typename UHash, typename BinaryPredicate>
  inline typename intrusive_hashtable<K, V, H, Eq, bC, bM, bU>::iterator
  intrusive_hashtable<K, V, H, Eq, bC, bM, bU>::find_as(const U& other, UHash uhash,
  ...
  intrusive_hashtable<K, V, H, Eq, bC, bM, bU>::DoFindNode(node_type*      pNode,
  ...
  template <typename K, typename V, typename H, typename Eq, size_t bC, bool bM, bool bU>
  template <typename InputIterator>
  inline void intrusive_hashtable<K, V, H, Eq, bC, bM, bU>::insert(InputIterator first,
                                                                   InputIterator last) {
