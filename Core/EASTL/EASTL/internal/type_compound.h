...
#define EASTL_TYPE_TRAIT_is_array_CONFORMANCE 1  // is_array is conforming; doesn't make mistakes.
    ...
    (defined(_MSC_VER_) && _MSC_VER < 1500)  // If the compiler is crippled...
  ...
  template <typename T>
  struct is_array : public integral_constant<bool, sizeof(is_array_tester2(is_array_tester1(
                                                       is_array_helper<T>::emptyInstance))) == 1> {
  };
...
#define EASTL_TYPE_TRAIT_is_member_function_pointer_CONFORMANCE \
  ...
  template <typename R, typename T, typename Arg0, typename Arg1, typename Arg2, typename Arg3,
            typename Arg4>
  struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1, Arg2, Arg3, Arg4) const volatile>
      : public true_type {};
  ...
  template <typename R, typename T, typename Arg0, typename Arg1, typename Arg2, typename Arg3,
            typename Arg4, typename Arg5>
  struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5) volatile>
      : public true_type {};
  template <typename R, typename T, typename Arg0, typename Arg1, typename Arg2, typename Arg3,
            typename Arg4, typename Arg5>
  struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5) const volatile>
      : public true_type {};
  ...
  template <typename R, typename T, typename Arg0, typename Arg1, typename Arg2, typename Arg3,
            typename Arg4, typename Arg5, typename Arg6>
  struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6) volatile>
      : public true_type {};
  template <typename R, typename T, typename Arg0, typename Arg1, typename Arg2, typename Arg3,
            typename Arg4, typename Arg5, typename Arg6>
...
#define EASTL_TYPE_TRAIT_is_class_CONFORMANCE EASTL_TYPE_TRAIT_is_union_CONFORMANCE
  ...
  template <typename T>
  struct is_class
      : public integral_constant<bool, sizeof(is_class_helper<T>(0)) == sizeof(yes_array_type) &&
                                           !is_union<T>::value> {};
...
#define EASTL_TYPE_TRAIT_is_class_CONFORMANCE EASTL_TYPE_TRAIT_is_union_CONFORMANCE
  ...
  template <typename T>
  struct is_class
      : public integral_constant<bool, sizeof(is_class_helper<T>(0)) == sizeof(yes_type) &&
                                           !is_union<T>::value> {};
#else
...
#define EASTL_TYPE_TRAIT_is_object_CONFORMANCE                                          \
  ...
  template <typename T>
  struct is_object : public integral_constant<bool, !is_reference<T>::value && !is_void<T>::value &&
                                                        !is_function<T>::value> {};
...
#define EASTL_TYPE_TRAIT_decay_CONFORMANCE 1  // decay is conforming.
  ...
  struct decay {
    ...
    typedef typename eastl::conditional<
        ...
        typename eastl::conditional<eastl::is_function<U>::value,
