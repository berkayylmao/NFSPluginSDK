...
namespace eastl {
  ...
  namespace Internal {
    ...
    struct pointer_type {
      typedef
          typename PointerTypeInternal::pointer_type<T, typename remove_reference<D>::type>::type
              type;
    };
    ...
    decltype(eastl::declval<Alloc>().construct(eastl::declval<T*>(), eastl::declval<Args>()...),
             eastl::true_type())
    ...
    struct has_construct
        : public eastl::integral_constant<
              bool, eastl::is_same<decltype(has_construct_test(eastl::declval<Alloc>(),
    ...
    decltype(eastl::declval<Alloc>().construct(eastl::declval<T*>(), eastl::declval<Arg0>()),
             eastl::true_type())
    ...
    template <class Alloc, class Pointer>
    struct has_destroy : public eastl::integral_constant<
    ...
    template <class Alloc>
    struct has_max_size : public eastl::integral_constant<
  ...
  // This Internal namespace holds the utility functions required for allocator_traits to do
  // compile-time type inspection inorder to determine if needs to provide a default implementation
  // or utilize the users allocator implementation.
  //
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  // eastl::allocator_traits is not a standards conforming implementation. Enough of the standard
  // was implemented to make the eastl::function implementation possible.  We must revisit this
  // implementation before rolling out its usage fully in eastl::containers.
  //
  // NOTE: We do not recommend users directly code against eastl::allocator_traits until we have
  // completed a full standards comforming implementation.
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  template <class Alloc>
  struct allocator_traits {
    ...
    typedef
        typename Internal::const_pointer<value_type, pointer, allocator_type>::type const_pointer;
    ...
    typedef typename Internal::alloc_traits_difference_type<allocator_type, pointer>::type
                                                                                difference_type;
    ...
    //
    // typedef typename Internal::propagate_on_container_copy_assignment<allocator_type>::type
    // propagate_on_container_copy_assignment; typedef typename
    // Internal::propagate_on_container_move_assignment<allocator_type>::type
    // propagate_on_container_move_assignment; typedef typename
    // Internal::propagate_on_container_swap<allocator_type>::type propagate_on_container_swap;
    ...
    static pointer allocate(allocator_type& a, size_type n, const_void_pointer) {
      // return allocate(a, n, hint, Internal::has_allocate_hint<allocator_type, size_type,
      // const_void_pointer>());
      return allocate(a, n);
    }
    ...
    static void construct(allocator_type& a, T* p, Args&&... args) {
      internal_construct(Internal::has_construct<allocator_type, T*, Args...>(), a, p,
