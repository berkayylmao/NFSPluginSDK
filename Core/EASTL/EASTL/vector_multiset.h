...
#define EASTL_VECTOR_MULTISET_DEFAULT_ALLOCATOR allocator_type(EASTL_VECTOR_MULTISET_DEFAULT_NAME)
  ...
  class vector_multiset : public RandomAccessContainer {
   ...
   public:
    ...
    explicit vector_multiset(const key_compare& comp, const allocator_type& allocator =
                                                          EASTL_VECTOR_MULTISET_DEFAULT_ALLOCATOR);
...
#endif
    vector_multiset(std::initializer_list<value_type> ilist,
    ...
    iterator insert(const value_type&
                        value);  // The signature of this function was change in EASTL v2.05.00 from
  ...
  template <typename K, typename C, typename A, typename RAC>
  inline vector_multiset<K, C, A, RAC>::vector_multiset(const key_compare&    comp,
  ...
  template <typename K, typename C, typename A, typename RAC>
  template <class... Args>
  typename vector_multiset<K, C, A, RAC>::iterator vector_multiset<K, C, A, RAC>::emplace(
      Args&&... args) {
  ...
  template <typename K, typename C, typename A, typename RAC>
  template <typename P>
  typename vector_multiset<K, C, A, RAC>::iterator vector_multiset<K, C, A, RAC>::insert(
      P&& otherValue) {
  ...
  inline typename vector_multiset<K, C, A, RAC>::iterator vector_multiset<K, C, A, RAC>::insert(
    ...
    {
      if ((position == begin()) ||
          !mCompare(value, *(position - 1)))  // If value is >= the element before position...
  ...
  template <typename K, typename C, typename A, typename RAC>
  inline typename vector_multiset<K, C, A, RAC>::size_type vector_multiset<K, C, A, RAC>::erase(
      const key_type& k) {
  ...
  template <typename K, typename C, typename A, typename RAC>
  inline typename vector_multiset<K, C, A, RAC>::iterator vector_multiset<K, C, A, RAC>::find(
      const key_type& k) {
    const eastl::pair<iterator, iterator> pairIts(equal_range(k));
