...
#include <Core/EASTL/EASTL/internal/smart_ptr.h>  // Defines smart_ptr_deleter
#include <Core/EASTL/EASTL/internal/move_help.h>  // Defines EASTL_MOVE
#include <Core/EASTL/EASTL/type_traits.h>
#include <Core/EASTL/EASTL/functional.h>
#include <Core/EASTL/EASTL/bonus/compressed_pair.h>
#include <stddef.h>
...
namespace eastl {
  ...
  class unique_ptr {
   ...
   public:
    ...
    unique_ptr(pointer pValue,
        ...
        EA_NOEXCEPT : mPair(pValue, deleter) {}
    ...
    unique_ptr(pointer                                                pValue,
               typename eastl::remove_reference<deleter_type>::type&& deleter) EA_NOEXCEPT
  ...
  class unique_ptr<T[], Deleter> {
   ...
   public:
    ...
    template <typename P>
    unique_ptr(
        P pArray, typename eastl::remove_reference<deleter_type>::type&& deleter,
        typename eastl::enable_if<Internal::is_array_cv_convertible<P, pointer>::value>::type* = 0)
    ...
    unique_ptr(unique_ptr<U, E>&& u,
               typename enable_if<Internal::is_safe_array_conversion<
...
// int[]).
  ...
  inline typename Internal::unique_type<T>::unique_type_single make_unique(A1&& a1, A2&& a2,
                                                                           A3&& a3) {
    return unique_ptr<T>(
        new T(eastl::forward<A1>(a1), eastl::forward<A2>(a2), eastl::forward<A3>(a3)));
  }
