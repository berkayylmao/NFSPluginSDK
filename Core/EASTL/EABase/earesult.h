...
#ifndef SUCCESS
    // Deprecated
    // Note: a public MS header has created a define of this name which causes a build error.
    // Fortunately they define it to 0 which is compatible. see:
    // WindowsSDK\8.1.51641-fb\installed\Include\um\RasError.h
    SUCCESS = 0,
#endif
    // Deprecated
    FAILURE = -1,
