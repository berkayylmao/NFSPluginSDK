...
#if defined(EA_PLATFORM_LRB) || defined(__LRB__) || \
...
#define EA_PLATFORM_PTR_SIZE ((__WORDSIZE) / 8)
    ...
    defined(__ia64__) || defined(__arch64__) || defined(__aarch64__) || defined(__mips64__) || \
    defined(__64BIT__) || defined(__Ptr_Is_64)
