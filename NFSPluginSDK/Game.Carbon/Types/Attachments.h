...
#ifndef NFSPLUGINSDK_GAME_CARBON_TYPES_ATTACHMENTS_H
#define NFSPLUGINSDK_GAME_CARBON_TYPES_ATTACHMENTS_H
#pragma once
...
#endif  // NFSPLUGINSDK_GAME_CARBON_TYPES_ATTACHMENTS_H
