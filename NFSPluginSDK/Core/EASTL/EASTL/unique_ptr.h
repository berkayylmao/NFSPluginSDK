...
#include <NFSPluginSDK/Core/EASTL/EASTL/internal/smart_ptr.h>  // Defines smart_ptr_deleter
#include <NFSPluginSDK/Core/EASTL/EASTL/internal/move_help.h>  // Defines EASTL_MOVE
