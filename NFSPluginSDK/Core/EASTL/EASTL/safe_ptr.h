...
namespace eastl {
  ...
  class safe_object {
   ...
   protected:
    ...
    void clear_references();  /// Forcibly removes any references (by smart_ptrs) to this object. All safe_ptr mpObject
  ...
  class safe_ptr_base {
   public:
    bool unique() const;  /// Returns true if there are no other smart pointers pointing to our object except us. True
                          /// if mpObject is NUll
  ...
  class safe_ptr : public safe_ptr_base {
   ...
   public:
    ...
    //~safe_ptr() {}                                    /// No need to implement this; the compiler-generated destructor
    //is OK.
