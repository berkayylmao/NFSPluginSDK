...
#ifndef NFSPLUGINSDK_GAME_PROSTREET_TYPES_DYNAMICS_H
#define NFSPLUGINSDK_GAME_PROSTREET_TYPES_DYNAMICS_H
#pragma once

#include <NFSPluginSDK/Game.ProStreet/Types.h>

namespace NFSPluginSDK::ProStreet::Dynamics {
  namespace Collision {
    struct Geometry {
...
#endif  // NFSPLUGINSDK_GAME_PROSTREET_TYPES_DYNAMICS_H
