...
#include <Game.MW05/Types/bList.h>
#include <Game.MW05/Types/IAttributeable.h>
#include <Game.MW05/Types/IExplodeable.h>
#include <Game.MW05/Types/IVehicle.h>
#include <Game.MW05/Types/PhysicsObject.h>
#include <Game.MW05/Types/VehicleParams.h>
...
namespace OpenSpeed::MW05 {
  struct PVehicle : PhysicsObject,
                    ...
                    IAttributeable,
                    bTNode<PVehicle*> {
    static inline const bTList<PVehicle>* g_mInstances =
        reinterpret_cast<bTList<PVehicle>*>(0x9352B0);
    ...
    static PVehicle* Construct(const VehicleParams& vehicleParams) {
      ISimable* pSimable = reinterpret_cast<ISimable*(__cdecl*)(const VehicleParams&, UCrc32)>(
          0x689820)(vehicleParams, vehicleParams.hash);
