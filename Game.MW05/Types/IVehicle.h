...
#include <Game.MW05/Types/Attrib.h>
#include <Game.MW05/Types/Physics.h>
...
namespace OpenSpeed::MW05 {
  struct IVehicle : UTL::COM::IUnknown {
    ...
    virtual FECustomizationRecord* GetCustomizations() = 0;  // VehicleCustomizations?
    virtual Physics::Tunings*      GetTunings()        = 0;
    virtual void                   SetTunings(const Physics::Tunings& newTunings)           = 0;
