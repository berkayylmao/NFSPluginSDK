...
namespace OpenSpeed::MW05::UMath {
  ...
  struct Vector4 {
    ...
    // RightVector: Roll
    void inline ExtractXAxis(Vector3* out) { ((void(__cdecl*)(Vector4*, Vector3*))0x5CA6F0)(this, out); }
    // UpVector: Pitch
    void inline ExtractYAxis(Vector3* out) { ((void(__cdecl*)(Vector4*, Vector3*))0x5CA7B0)(this, out); }
    // ForwardVector: Yaw
    void inline ExtractZAxis(Vector3* out) { ((void(__cdecl*)(Vector4*, Vector3*))0x5CA870)(this, out); }
