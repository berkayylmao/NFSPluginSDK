...
// explicitly defaulting copy constructor
    ...
    struct TupleConvertibleImpl<true, TupleTypes<FromFirst, FromRest...>, TupleTypes<ToFirst, ToRest...>>
        : public integral_constant<
              bool, is_convertible<FromFirst, ToFirst>::value &&
                        TupleConvertibleImpl<true, TupleTypes<FromRest...>, TupleTypes<ToRest...>>::value> {};
    ...
    struct TupleAssignableImpl<true, TupleTypes<TargetFirst, TargetRest...>, TupleTypes<FromFirst, FromRest...>>
        : public integral_constant<
              bool, is_assignable<TargetFirst, FromFirst>::value &&
