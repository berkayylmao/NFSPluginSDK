...
namespace eastl {
  ...
  namespace Internal {
    ...
    struct numeric_limits_base {
      ...
      // The number of decimal digits required to make sure that two distinct values of the type have distinct decimal
      // representations.
      ...
      // In practice the application or OS can change this at runtime via hardware-specific commands or via compiler
      // optimizations.
