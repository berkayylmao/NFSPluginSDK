  ...
  namespace Internal {
    ...
    struct ratio_add {
      typedef typename ct_simplify<
          typename ratio<ct_add<ct_multi<R1::num, R2::den>::value, ct_multi<R2::num, R1::den>::value>::value,
    ...
    struct ratio_subtract {
      typedef typename ct_simplify<
          typename ratio<ct_sub<ct_multi<R1::num, R2::den>::value, ct_multi<R2::num, R1::den>::value>::value,
                         ct_multi<R1::den, R2::den>::value>::type>::ratio_type type;
    };
    ...
    struct ratio_multiply {
      typedef typename ct_simplify<
          typename ratio<ct_multi<R1::num, R2::num>::value, ct_multi<R1::den, R2::den>::value>::type>::ratio_type type;
    };
    ...
    struct ratio_divide {
      typedef typename ct_simplify<
          typename ratio<ct_multi<R1::num, R2::den>::value, ct_multi<R1::den, R2::num>::value>::type>::ratio_type type;
    };
...
///////////////////////////////////////////////////////////////////////
  ...
  ///////////////////////////////////////////////////////////////////////
  template <class R1, class R2>
  struct ratio_equal : public integral_constant<bool, Internal::ratio_equal<R1, R2>::value> {};
  template <class R1, class R2>
  struct ratio_not_equal : public integral_constant<bool, !ratio_equal<R1, R2>::value> {};
  template <class R1, class R2>
  struct ratio_less : public integral_constant<bool, Internal::ratio_less<R1, R2>::value> {};
  template <class R1, class R2>
  struct ratio_less_equal : public integral_constant<bool, !ratio_less<R2, R1>::value> {};
  template <class R1, class R2>
  struct ratio_greater : public integral_constant<bool, ratio_less<R2, R1>::value> {};
  template <class R1, class R2>
  struct ratio_greater_equal : public integral_constant<bool, !ratio_less<R1, R2>::value> {};
