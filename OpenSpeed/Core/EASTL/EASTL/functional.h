...
namespace eastl {
  ...
  struct plus : public binary_function<T, T, T> {
    EA_CPP14_CONSTEXPR T operator()(const T& a, const T& b) const { return a + b; }
  };
  ...
  struct negate : public unary_function<T, T> {
    EA_CPP14_CONSTEXPR T operator()(const T& a) const { return -a; }
  };
  ...
  struct logical_not : public unary_function<T, bool> {
    EA_CPP14_CONSTEXPR bool operator()(const T& a) const { return !a; }
  };
  ...
  struct equal_to_2 : public binary_function<T, U, bool> {
    EA_CPP14_CONSTEXPR bool operator()(const T& a, const U& b) const { return a == b; }
    EA_CPP14_CONSTEXPR bool operator()(const U& b,
                                       const T& a) const  // If you are getting a 'operator() already defined' error
                                                          // related to on this line while compiling a
    {
      return b == a;
    }  // hashtable class (e.g. hash_map), it's likely that you are using hashtable::find_as when
       // you should
  };   // be using hashtable::find instead. The problem is that (const T, U) collide. To do: make
       // this work.
  ...
  struct not_equal_to_2 : public binary_function<T, U, bool> {
    EA_CPP14_CONSTEXPR bool operator()(const T& a, const U& b) const { return a != b; }
    EA_CPP14_CONSTEXPR bool operator()(const U& b, const T& a) const { return b != a; }
  };
  ...
  class unary_negate : public unary_function<typename Predicate::argument_type, bool> {
   ...
   public:
    explicit unary_negate(const Predicate& a) : mPredicate(a) {}
    EA_CPP14_CONSTEXPR bool operator()(const typename Predicate::argument_type& a) const { return !mPredicate(a); }
  };
  ...
  class binary_negate : public binary_function<typename Predicate::first_argument_type,
   ...
   public:
    explicit binary_negate(const Predicate& a) : mPredicate(a) {}
    EA_CPP14_CONSTEXPR bool operator()(const typename Predicate::first_argument_type&  a,
  ...
  struct unary_compose : public unary_function<typename Operation2::argument_type, typename Operation1::result_type> {
   ...
   public:
    ...
    typename Operation1::result_type operator()(typename Operation2::argument_type& x) const { return op1(op2(x)); }
  };
  ...
  class binary_compose : public unary_function<typename Operation2::argument_type, typename Operation1::result_type> {
   ...
   public:
    ...
    typename Operation1::result_type operator()(typename Operation2::argument_type& x,
  ...
  ///
  /// Example usage:
  ///     ptrdiff_t Rand(ptrdiff_t n) { return rand() % n; } // Note: The C rand function is poor
  ///     and slow. pointer_to_unary_function<ptrdiff_t, ptrdiff_t> randInstance(Rand);
  ...
  class pointer_to_unary_function : public unary_function<Arg, Result> {
   ...
   public:
    ...
    explicit pointer_to_unary_function(Result (*pFunction)(Arg)) : mpFunction(pFunction) {}

    Result operator()(Arg x) const { return mpFunction(x); }
  };
  ...
  class pointer_to_binary_function : public binary_function<Arg1, Arg2, Result> {
   ...
   public:
    ...
    explicit pointer_to_binary_function(Result (*pFunction)(Arg1, Arg2)) : mpFunction(pFunction) {}

    Result operator()(Arg1 x, Arg2 y) const { return mpFunction(x, y); }
  };
  ...
  ///    transform(pIntArray1Begin, pIntArray1End, pIntArray2Begin, pIntArray1Begin,
  ///    ptr_fun(multiply));
  ///
  template <typename Arg1, typename Arg2, typename Result>
  ...
  class mem_fun_t : public unary_function<T*, Result> {
   public:
    ...
    inline explicit mem_fun_t(MemberFunction pMemberFunction) : mpMemberFunction(pMemberFunction) {
      // Empty
    }

    inline Result operator()(T* pT) const { return (pT->*mpMemberFunction)(); }
  ...
  class mem_fun1_t : public binary_function<T*, Argument, Result> {
   public:
    ...
    inline explicit mem_fun1_t(MemberFunction pMemberFunction) : mpMemberFunction(pMemberFunction) {
      // Empty
    }

    inline Result operator()(T* pT, Argument arg) const { return (pT->*mpMemberFunction)(arg); }
  ...
  class const_mem_fun_t : public unary_function<const T*, Result> {
   public:
    ...
    inline explicit const_mem_fun_t(MemberFunction pMemberFunction) : mpMemberFunction(pMemberFunction) {
      // Empty
    }

    inline Result operator()(const T* pT) const { return (pT->*mpMemberFunction)(); }
  ...
  class const_mem_fun1_t : public binary_function<const T*, Argument, Result> {
   public:
    ...
    inline explicit const_mem_fun1_t(MemberFunction pMemberFunction) : mpMemberFunction(pMemberFunction) {
      // Empty
    }

    inline Result operator()(const T* pT, Argument arg) const { return (pT->*mpMemberFunction)(arg); }
  ...
  template <typename Result, typename T, typename Argument>
  inline const_mem_fun1_t<Result, T, Argument> mem_fun(Result (T::*MemberFunction)(Argument) const) {
  ...
  class mem_fun_ref_t : public unary_function<T, Result> {
   public:
    ...
    inline explicit mem_fun_ref_t(MemberFunction pMemberFunction) : mpMemberFunction(pMemberFunction) {
      // Empty
    }

    inline Result operator()(T& t) const { return (t.*mpMemberFunction)(); }
  ...
  class mem_fun1_ref_t : public binary_function<T, Argument, Result> {
   public:
    ...
    inline explicit mem_fun1_ref_t(MemberFunction pMemberFunction) : mpMemberFunction(pMemberFunction) {
      // Empty
    }

    inline Result operator()(T& t, Argument arg) const { return (t.*mpMemberFunction)(arg); }
  ...
  class const_mem_fun_ref_t : public unary_function<T, Result> {
   public:
    ...
    inline explicit const_mem_fun_ref_t(MemberFunction pMemberFunction) : mpMemberFunction(pMemberFunction) {
      // Empty
    }

    inline Result operator()(const T& t) const { return (t.*mpMemberFunction)(); }
  ...
  class const_mem_fun1_ref_t : public binary_function<T, Argument, Result> {
   public:
    ...
    inline explicit const_mem_fun1_ref_t(MemberFunction pMemberFunction) : mpMemberFunction(pMemberFunction) {
      // Empty
    }

    inline Result operator()(const T& t, Argument arg) const { return (t.*mpMemberFunction)(arg); }
  ...
  template <typename Result, typename T, typename Argument>
  inline mem_fun1_ref_t<Result, T, Argument> mem_fun_ref(Result (T::*MemberFunction)(Argument)) {
    return eastl::mem_fun1_ref_t<Result, T, Argument>(MemberFunction);
  }

  template <typename Result, typename T>
  inline const_mem_fun_ref_t<Result, T> mem_fun_ref(Result (T::*MemberFunction)() const) {
    return eastl::const_mem_fun_ref_t<Result, T>(MemberFunction);
  }

  template <typename Result, typename T, typename Argument>
  inline const_mem_fun1_ref_t<Result, T, Argument> mem_fun_ref(Result (T::*MemberFunction)(Argument) const) {
  ...
  template <typename T>
  struct hash<T*>  // Note that we use the pointer as-is and don't divide by sizeof(T*). This is
                   // because the table is of a prime size and this division doesn't benefit
                   // distribution.
  {
...
// If wchar_t is a native type instead of simply a define to an existing type...
  ...
  struct hash<char8_t*> {
    size_t operator()(const char8_t* p) const {
      uint32_t c,
          result = 2166136261U;         // FNV1 hash. Perhaps the best string hash. Intentionally uint32_t
                                        // instead of size_t, so the behavior is the same regardless of size.
  ...
  struct hash<const char8_t*> {
    size_t operator()(const char8_t* p) const {
      uint32_t c, result = 2166136261U;  // Intentionally uint32_t instead of size_t, so the
...
EA_DISABLE_VC_WARNING(4510 4512 4610)  // disable warning: function_manager not generating default
                                       // constructor and default assignment operators.
#include <OpenSpeed/Core/EASTL/EASTL/internal/function.h>
