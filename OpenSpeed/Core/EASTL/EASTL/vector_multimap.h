...
#define EASTL_VECTOR_MULTIMAP_DEFAULT_ALLOCATOR allocator_type(EASTL_VECTOR_MULTIMAP_DEFAULT_NAME)
  ...
  class multimap_value_compare : public binary_function<Value, Value, bool> {
   public:
    ...
    multimap_value_compare(const Compare& x) : c(x) {}
   ...
   public:
    ...
    bool operator()(const Key& a, const Key& b) const { return c(a, b); }
  ...
  class vector_multimap : public RandomAccessContainer {
   ...
   public:
    ...
    explicit vector_multimap(const key_compare&    comp,
...
#endif
    vector_multimap(std::initializer_list<value_type> ilist, const key_compare& compare = key_compare(),
                    const allocator_type& allocator = EASTL_VECTOR_MULTIMAP_DEFAULT_ALLOCATOR);
    ...
    template <typename InputIterator>
    vector_multimap(InputIterator first, InputIterator last,
    ...
    eastl::pair<iterator, iterator> equal_range_small(const key_type& k) {
      ...
      while ((itUpper != end()) && !mValueCompare(k, *itUpper)) ++itUpper;
  ...
  inline vector_multimap<K, T, C, A, RAC>::vector_multimap() : base_type(), mValueCompare(C()) {
  ...
  template <typename K, typename T, typename C, typename A, typename RAC>
  inline vector_multimap<K, T, C, A, RAC>::vector_multimap(std::initializer_list<value_type> ilist,
  ...
  template <typename K, typename T, typename C, typename A, typename RAC>
  inline typename vector_multimap<K, T, C, A, RAC>::this_type& vector_multimap<K, T, C, A, RAC>::operator=(
      const this_type& x) {
  ...
  template <typename K, typename T, typename C, typename A, typename RAC>
  inline const typename vector_multimap<K, T, C, A, RAC>::key_compare& vector_multimap<K, T, C, A, RAC>::key_comp()
      const {
    return mValueCompare.c;
  }

  template <typename K, typename T, typename C, typename A, typename RAC>
  inline typename vector_multimap<K, T, C, A, RAC>::key_compare& vector_multimap<K, T, C, A, RAC>::key_comp() {
    return mValueCompare.c;
  }

  template <typename K, typename T, typename C, typename A, typename RAC>
  inline const typename vector_multimap<K, T, C, A, RAC>::value_compare& vector_multimap<K, T, C, A, RAC>::value_comp()
      const {
    return mValueCompare;
  }

  template <typename K, typename T, typename C, typename A, typename RAC>
  inline typename vector_multimap<K, T, C, A, RAC>::value_compare& vector_multimap<K, T, C, A, RAC>::value_comp() {
    return mValueCompare;
  }
  ...
  template <typename K, typename T, typename C, typename A, typename RAC>
  template <class... Args>
  inline typename vector_multimap<K, T, C, A, RAC>::iterator vector_multimap<K, T, C, A, RAC>::emplace(Args&&... args) {
  ...
  template <typename K, typename T, typename C, typename A, typename RAC>
  template <class... Args>
  inline typename vector_multimap<K, T, C, A, RAC>::iterator vector_multimap<K, T, C, A, RAC>::emplace_hint(
...
#if EASTL_MOVE_SEMANTICS_ENABLED
  template <typename K, typename T, typename C, typename A, typename RAC>
  inline typename vector_multimap<K, T, C, A, RAC>::iterator vector_multimap<K, T, C, A, RAC>::emplace(
      value_type&& value) {
    return insert(eastl::move(value));
  }
  ...
  template <typename K, typename T, typename C, typename A, typename RAC>
  inline typename vector_multimap<K, T, C, A, RAC>::iterator vector_multimap<K, T, C, A, RAC>::insert(
      const value_type& value) {
  ...
  template <typename K, typename T, typename C, typename A, typename RAC>
  template <typename P>
  inline typename vector_multimap<K, T, C, A, RAC>::iterator vector_multimap<K, T, C, A, RAC>::insert(P&& otherValue) {
  ...
  inline typename vector_multimap<K, T, C, A, RAC>::iterator vector_multimap<K, T, C, A, RAC>::insert(
    ...
    {
      if ((position == begin()) ||
          !mValueCompare(value, *(position - 1)))  // If value is >= the element before position...
  ...
  inline void vector_multimap<K, T, C, A, RAC>::insert(InputIterator first, InputIterator last) {
    ...
    for (; first != last; ++first) base_type::insert(lower_bound((*first).first), *first);
  }

  template <typename K, typename T, typename C, typename A, typename RAC>
  inline typename vector_multimap<K, T, C, A, RAC>::iterator vector_multimap<K, T, C, A, RAC>::erase(
  ...
  template <typename K, typename T, typename C, typename A, typename RAC>
  inline typename vector_multimap<K, T, C, A, RAC>::size_type vector_multimap<K, T, C, A, RAC>::erase(
      const key_type& k) {
  ...
  template <typename K, typename T, typename C, typename A, typename RAC>
  inline typename vector_multimap<K, T, C, A, RAC>::reverse_iterator vector_multimap<K, T, C, A, RAC>::erase(
  ...
  template <typename K, typename T, typename C, typename A, typename RAC>
  inline typename vector_multimap<K, T, C, A, RAC>::iterator vector_multimap<K, T, C, A, RAC>::find(const key_type& k) {
    const eastl::pair<iterator, iterator> pairIts(equal_range(k));
  ...
  template <typename K, typename T, typename C, typename A, typename RAC>
  inline typename vector_multimap<K, T, C, A, RAC>::const_iterator vector_multimap<K, T, C, A, RAC>::find(
  ...
  template <typename K, typename T, typename C, typename A, typename RAC>
  template <typename U, typename BinaryPredicate>
  inline typename vector_multimap<K, T, C, A, RAC>::const_iterator vector_multimap<K, T, C, A, RAC>::find_as(
  ...
  template <typename K, typename T, typename C, typename A, typename RAC>
  template <typename U, typename BinaryPredicate>
  inline typename vector_multimap<K, T, C, A, RAC>::iterator vector_multimap<K, T, C, A, RAC>::find_as(
  ...
  template <typename K, typename T, typename C, typename A, typename RAC>
  inline typename vector_multimap<K, T, C, A, RAC>::size_type vector_multimap<K, T, C, A, RAC>::count(
      const key_type& k) {
    const eastl::pair<const_iterator, const_iterator> pairIts(equal_range(k));
  ...
  template <typename K, typename T, typename C, typename A, typename RAC>
  inline typename vector_multimap<K, T, C, A, RAC>::iterator vector_multimap<K, T, C, A, RAC>::lower_bound(
      const key_type& k) {
    return eastl::lower_bound(begin(), end(), k, mValueCompare);
  }

  template <typename K, typename T, typename C, typename A, typename RAC>
  inline typename vector_multimap<K, T, C, A, RAC>::const_iterator vector_multimap<K, T, C, A, RAC>::lower_bound(
      const key_type& k) const {
    return eastl::lower_bound(begin(), end(), k, mValueCompare);
  }

  template <typename K, typename T, typename C, typename A, typename RAC>
  inline typename vector_multimap<K, T, C, A, RAC>::iterator vector_multimap<K, T, C, A, RAC>::upper_bound(
      const key_type& k) {
    return eastl::upper_bound(begin(), end(), k, mValueCompare);
  }

  template <typename K, typename T, typename C, typename A, typename RAC>
  inline typename vector_multimap<K, T, C, A, RAC>::const_iterator vector_multimap<K, T, C, A, RAC>::upper_bound(
      const key_type& k) const {
    return eastl::upper_bound(begin(), end(), k, mValueCompare);
  }
  ...
  vector_multimap. template <typename K, typename T, typename C, typename A, typename RAC> inline
  eastl::pair<typename vector_multimap<K, T, C, A, RAC>::iterator, typename vector_multimap<K, T, C,
  A, RAC>::iterator> vector_multimap<K, T, C, A, RAC>::equal_range_small(const key_type& k)
  {
          const iterator itLower(lower_bound(k));
          iterator       itUpper(itLower);
  ...
  */
  ...
  template <typename K, typename T, typename C, typename A, typename RAC>
  inline bool operator==(const vector_multimap<K, T, C, A, RAC>& a, const vector_multimap<K, T, C, A, RAC>& b) {
  ...
  template <typename K, typename T, typename C, typename A, typename RAC>
  inline void swap(vector_multimap<K, T, C, A, RAC>& a, vector_multimap<K, T, C, A, RAC>& b) {
    a.swap(b);
  }
