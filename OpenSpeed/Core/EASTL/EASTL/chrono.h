...
#include <OpenSpeed/Core/EASTL/EASTL/ratio.h>
...
namespace eastl {
  namespace chrono {
    ...
    inline typename eastl::enable_if<Internal::IsDuration<ToDuration>::value, ToDuration>::type duration_cast(
    ...
    class duration {
     ...
     public:
      ...
      inline EA_CONSTEXPR explicit duration(
          const Rep2& rep2, typename eastl::enable_if<eastl::is_convertible<Rep2, Rep>::value &&
    ...
    ///////////////////////////////////////////////////////////////////////////////
    template <typename Rep1, typename Period1, typename Rep2, typename Period2>
    EASTL_FORCE_INLINE bool operator==(const duration<Rep1, Period1>& lhs, const duration<Rep2, Period2>& rhs) {
      typedef typename eastl::common_type<duration<Rep1, Period1>, duration<Rep2, Period2>>::type common_duration_t;
    ...
    inline EA_CONSTEXPR time_point<Clock, typename eastl::common_type<Duration1, duration<Rep2, Period2>>::type>
      ...
      typedef time_point<Clock, typename eastl::common_type<Duration1, duration<Rep2, Period2>>::type>
          common_timepoint_t;
    ...
    inline EA_CONSTEXPR time_point<Clock, typename eastl::common_type<Duration2, duration<Rep1, Period1>>::type>
      ...
      typedef time_point<Clock, typename eastl::common_type<Duration2, duration<Rep1, Period1>>::type>
          common_timepoint_t;
