...
#define EASTL_MACRO_SWAP(Type, a, b) \
  ...
  struct hashtable_iterator_base {
   ...
   protected:
    template <typename, typename, typename, typename, typename, typename, typename, typename, typename, bool, bool,
              bool>
  ...
  template <typename Key, typename Value, typename Allocator, typename ExtractKey, typename Equal, typename H1,
            typename H2, typename H, typename RehashPolicy, bool bCacheHashCode, bool bMutableIterators,
            bool bUniqueKeys>
  class hashtable
      : public rehash_base<RehashPolicy, hashtable<Key, Value, Allocator, ExtractKey, Equal, H1, H2, H, RehashPolicy,
...
#if EASTL_MOVE_SEMANTICS_ENABLED
    eastl::pair<iterator, bool> DoInsertValueExtra(true_type, const key_type& k, hash_code_t c, node_type* pNodeNew,
                                                   value_type&& value);
  ...
  hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::hashtable(size_type nBucketCount, const H1& h1, const H2& h2,
                                                                   const H& h, const Eq& eq, const EK& ek,
                                                                   const allocator_type& allocator) :
  ...
  hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::hashtable(FowardIterator first, FowardIterator last,
                                                                   size_type nBucketCount, const H1& h1, const H2& h2,
                                                                   const H& h, const Eq& eq, const EK& ek,
                                                                   const allocator_type& allocator) :
  ...
  hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoAllocateBuckets(size_type n) {
    ...
    EASTL_CT_ASSERT(kHashtableAllocFlagBuckets == 0x00400000);  // Currently we expect this to be so, because the
                                                                // allocator has a copy of this enum.
  ...
  void hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::swap(this_type& x) {
    if (mAllocator == x.mAllocator)  // If allocators are equivalent...
    {
      ...
      EASTL_MACRO_SWAP(node_type**, mpBucketArray,
...
// do a rehash if the allocation throws.
  ...
  hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::emplace(Args&&... args) {
    return DoInsertValue(has_unique_keys_type(),
