...
namespace eastl {
  ...
  class intrusive_hashtable {
   ...
   protected:
    node_type* mBucketArray[kBucketCount +
   ...
   public:
    ...
    iterator  remove(value_type& value);  // Removes by value instead of by iterator. This is an O(1) operation, due to
                                          // this hashtable being 'intrusive'.
