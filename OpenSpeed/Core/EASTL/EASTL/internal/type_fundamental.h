...
#define EASTL_TYPE_TRAIT_is_null_pointer_CONFORMANCE 1
  ...
  };  // A C++11 compiler defines nullptr, but you need a C++11 standard library to declare std::nullptr_t. So it's
      // safer to compare against decltype(nullptr) than to use std::nullptr_t, because we may have a C++11 compiler but
      // C++98 library (happens with Apple frequently).
#else
#define EASTL_TYPE_TRAIT_is_null_pointer_CONFORMANCE 1
...
#endif
#ifndef EA_WCHAR_T_NON_NATIVE  // If wchar_t is a native type instead of simply a define to an existing type which is
...
#define EASTL_TYPE_TRAIT_is_fundamental_CONFORMANCE 1  // is_fundamental is conforming.
  ...
  ///////////////////////////////////////////////////////////////////////
    ...
    (defined(_MSC_VER) || defined(EA_COMPILER_GNUC) || (defined(__clang__) && EA_COMPILER_HAS_FEATURE(is_enum)))
