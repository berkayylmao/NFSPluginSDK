...
namespace eastl {
  ...
  template <class R, class C, class A1>
  struct weak_result_type<R (C::*)(A1) const volatile> : public binary_function<const volatile C*, A1, R> {};
  ...
  EASTL_FORCE_INLINE auto invoke_impl(F&& f, A0&& a0) -> decltype(eastl::forward<F>(f)(eastl::forward<A0>(a0))) {
