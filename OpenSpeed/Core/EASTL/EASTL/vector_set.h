...
#define EASTL_VECTOR_SET_DEFAULT_ALLOCATOR allocator_type(EASTL_VECTOR_SET_DEFAULT_NAME)
  ...
  class vector_set : public RandomAccessContainer {
   ...
   public:
    ...
    explicit vector_set(const key_compare&    compare,
...
#endif
    vector_set(std::initializer_list<value_type> ilist, const key_compare& compare = key_compare(),
               const allocator_type& allocator = EASTL_VECTOR_SET_DEFAULT_ALLOCATOR);
    ...
    vector_set(InputIterator first, InputIterator last,
               const key_compare& compare);  // allocator arg removed because VC7.1 fails on the default arg. To
                                             // do: Make a second version of this function without a default arg.
  ...
  inline vector_set<K, C, A, RAC>::vector_set() : base_type(), mCompare(C()) {
    get_allocator().set_name(EASTL_VECTOR_SET_DEFAULT_NAME);
  }

  template <typename K, typename C, typename A, typename RAC>
  inline vector_set<K, C, A, RAC>::vector_set(const allocator_type& allocator) : base_type(allocator), mCompare(C()) {
    // Empty
  }
  ...
  template <typename K, typename C, typename A, typename RAC>
  inline vector_set<K, C, A, RAC>::vector_set(const this_type& x) : base_type(x), mCompare(x.mCompare) {
    // Empty
  }

#if EASTL_MOVE_SEMANTICS_ENABLED
  template <typename K, typename C, typename A, typename RAC>
  inline vector_set<K, C, A, RAC>::vector_set(this_type&& x) : base_type(eastl::move(x)), mCompare(x.mCompare) {
  ...
  template <typename K, typename C, typename A, typename RAC>
  inline vector_set<K, C, A, RAC>::vector_set(std::initializer_list<value_type> ilist, const key_compare& compare,
  ...
  template <typename K, typename C, typename A, typename RAC>
  inline vector_set<K, C, A, RAC>& vector_set<K, C, A, RAC>::operator=(const this_type& x) {
...
#if EASTL_MOVE_SEMANTICS_ENABLED
  template <typename K, typename C, typename A, typename RAC>
  inline vector_set<K, C, A, RAC>& vector_set<K, C, A, RAC>::operator=(this_type&& x) {
  ...
  template <typename K, typename C, typename A, typename RAC>
  inline vector_set<K, C, A, RAC>& vector_set<K, C, A, RAC>::operator=(std::initializer_list<value_type> ilist) {
    base_type::clear();
    insert(ilist.begin(), ilist.end());
    return *this;
  }
  ...
  template <typename K, typename C, typename A, typename RAC>
  inline const typename vector_set<K, C, A, RAC>::key_compare& vector_set<K, C, A, RAC>::key_comp() const {
    return mCompare;
  }

  template <typename K, typename C, typename A, typename RAC>
  inline typename vector_set<K, C, A, RAC>::key_compare& vector_set<K, C, A, RAC>::key_comp() {
    return mCompare;
  }

  template <typename K, typename C, typename A, typename RAC>
  inline const typename vector_set<K, C, A, RAC>::value_compare& vector_set<K, C, A, RAC>::value_comp() const {
    return mCompare;
  }

  template <typename K, typename C, typename A, typename RAC>
  inline typename vector_set<K, C, A, RAC>::value_compare& vector_set<K, C, A, RAC>::value_comp() {
    return mCompare;
  }
  ...
  template <typename K, typename C, typename A, typename RAC>
  template <class... Args>
  inline eastl::pair<typename vector_set<K, C, A, RAC>::iterator, bool> vector_set<K, C, A, RAC>::emplace(
      Args&&... args) {
  ...
  template <typename K, typename C, typename A, typename RAC>
  template <class... Args>
  inline typename vector_set<K, C, A, RAC>::iterator vector_set<K, C, A, RAC>::emplace_hint(const_iterator position,
                                                                                            Args&&... args) {
#if EASTL_USE_FORWARD_WORKAROUND
    auto value = value_type(eastl::forward<Args>(args)...);  // Workaround for compiler bug in VS2013 which results in a
                                                             // compiler internal crash while compiling this code.
  ...
  template <typename K, typename C, typename A, typename RAC>
  inline eastl::pair<typename vector_set<K, C, A, RAC>::iterator, bool> vector_set<K, C, A, RAC>::insert(
      const value_type& value) {
    const iterator itLB(lower_bound(value));

    if ((itLB != end()) && !mCompare(value, *itLB)) return eastl::pair<iterator, bool>(itLB, false);
  ...
  template <typename K, typename C, typename A, typename RAC>
  inline typename vector_set<K, C, A, RAC>::iterator vector_set<K, C, A, RAC>::insert(const_iterator    position,
                                                                                      const value_type& value) {
    ...
    {
      if ((position == begin()) ||
          mCompare(*(position - 1), value))  // If the element before position is less than value...
  ...
  template <typename K, typename C, typename A, typename RAC>
  inline typename vector_set<K, C, A, RAC>::iterator vector_set<K, C, A, RAC>::erase(const_iterator position) {
  ...
  template <typename K, typename C, typename A, typename RAC>
  inline typename vector_set<K, C, A, RAC>::iterator vector_set<K, C, A, RAC>::erase(const_iterator first,
                                                                                     const_iterator last) {
    return base_type::erase(first, last);
  }

  template <typename K, typename C, typename A, typename RAC>
  inline typename vector_set<K, C, A, RAC>::size_type vector_set<K, C, A, RAC>::erase(const key_type& k) {
  ...
  template <typename K, typename C, typename A, typename RAC>
  inline typename vector_set<K, C, A, RAC>::reverse_iterator vector_set<K, C, A, RAC>::erase(
  ...
  template <typename K, typename C, typename A, typename RAC>
  inline typename vector_set<K, C, A, RAC>::iterator vector_set<K, C, A, RAC>::find(const key_type& k) {
  ...
  template <typename K, typename C, typename A, typename RAC>
  inline typename vector_set<K, C, A, RAC>::const_iterator vector_set<K, C, A, RAC>::find(const key_type& k) const {
  ...
  template <typename K, typename C, typename A, typename RAC>
  template <typename U, typename BinaryPredicate>
  inline typename vector_set<K, C, A, RAC>::iterator vector_set<K, C, A, RAC>::find_as(const U& u,
  ...
  template <typename K, typename C, typename A, typename RAC>
  template <typename U, typename BinaryPredicate>
  inline typename vector_set<K, C, A, RAC>::const_iterator vector_set<K, C, A, RAC>::find_as(
  ...
  template <typename K, typename C, typename A, typename RAC>
  inline typename vector_set<K, C, A, RAC>::size_type vector_set<K, C, A, RAC>::count(const key_type& k) {
    const const_iterator it(find(k));
    return (it != end()) ? (size_type)1 : (size_type)0;
  }

  template <typename K, typename C, typename A, typename RAC>
  inline typename vector_set<K, C, A, RAC>::iterator vector_set<K, C, A, RAC>::lower_bound(const key_type& k) {
    return eastl::lower_bound(begin(), end(), k, mCompare);
  }

  template <typename K, typename C, typename A, typename RAC>
  inline typename vector_set<K, C, A, RAC>::const_iterator vector_set<K, C, A, RAC>::lower_bound(
      const key_type& k) const {
    return eastl::lower_bound(begin(), end(), k, mCompare);
  }

  template <typename K, typename C, typename A, typename RAC>
  inline typename vector_set<K, C, A, RAC>::iterator vector_set<K, C, A, RAC>::upper_bound(const key_type& k) {
    return eastl::upper_bound(begin(), end(), k, mCompare);
  }

  template <typename K, typename C, typename A, typename RAC>
  inline typename vector_set<K, C, A, RAC>::const_iterator vector_set<K, C, A, RAC>::upper_bound(
      const key_type& k) const {
    return eastl::upper_bound(begin(), end(), k, mCompare);
  }
