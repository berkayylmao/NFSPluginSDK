...
#include <OpenSpeed/Core/EASTL/EASTL/bonus/call_traits.h>
...
EA_DISABLE_VC_WARNING(4626 5027)             // warning C4626: 'eastl::compressed_pair_imp<T1,T2,0>':
                                             // assignment operator was implicitly defined as deleted because a
...
namespace eastl {
  ...
  class compressed_pair
      : private compressed_pair_imp<
            T1, T2,
            compressed_pair_switch<T1, T2, is_same<typename remove_cv<T1>::type, typename remove_cv<T2>::type>::value,
  ...
  class compressed_pair<T, T>
      : private compressed_pair_imp<
            T, T,
            compressed_pair_switch<T, T, is_same<typename remove_cv<T>::type, typename remove_cv<T>::type>::value,
