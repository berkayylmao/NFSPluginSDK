...
#endif
#if (__GNUC__ == 3) && \
    ((__GNUC_MINOR__ == 1) || (__GNUC_MINOR__ == 2))  // If GCC 3.1 or 3.2 (but not pre 3.1 or post 3.2)...
...
#if defined(_MSC_VER)
#define EA_COMPILER_STRING                                                                                            \
  EA_COMPILER_NAME " compiler, version " INTERNAL_STRINGIZE(EA_COMPILER_VERSION) ", EDG version " INTERNAL_STRINGIZE( \
...
#define EA_DISABLE_ALL_VC_WARNINGS() \
  __pragma(warning(push, 0))         \
      __pragma(warning(disable : 4244 4265 4267 4350 4472 4509 4548 4710 4985 6320 4755))  // Some warnings need to
...
#elif (defined(EA_COMPILER_NO_EXCEPTIONS) || defined(_MSL_NO_THROW_SPECS)) && !defined(EA_COMPILER_RVCT) && \
...
//
    ...
    (defined(_MSC_VER) && (EA_COMPILER_VERSION >= 1900))  // VS2015+... Not present in VC++ up to and including VS2013.
                                                          // supported.
...
//
    ...
    (EA_COMPILER_VERSION > 1600)  // VC++ > VS2010, even without C++11 support. VS2010 does support override, however
                                  // will generate warnings due to the keyword being 'non-standard' supported.
