...
#ifndef OPENSPEED_GAME_CARBON_TYPES_UMATH_H
#define OPENSPEED_GAME_CARBON_TYPES_UMATH_H
#pragma once

#include <cmath>  // sqrt

namespace OpenSpeed::Carbon::UMath {
  struct Vector2;
  struct Vector3;
  struct Vector4;
  struct Matrix4;
...
#endif  // OPENSPEED_GAME_CARBON_TYPES_UMATH_H
