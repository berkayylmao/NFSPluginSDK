...
#ifndef OPENSPEED_GAME_PROSTREET_TYPES_IINPUTPLAYER_H
#define OPENSPEED_GAME_PROSTREET_TYPES_IINPUTPLAYER_H
#pragma once
...
#endif  // OPENSPEED_GAME_PROSTREET_TYPES_IINPUTPLAYER_H
